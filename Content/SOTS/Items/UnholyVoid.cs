...
{
	public class UnholyVoid : DamageClass
	{
        ...
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
			...
			ModLoader.TryGetMod("SOTS", out Mod SOTS);
            if (damageClass == DamageClass.Generic || damageClass == ModContent.GetInstance<DamageClasses.Unholy>() || damageClass == SOTS.Find<DamageClass>("VoidGeneric")) {
    ...
    public class UnholyVoidMelee : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
		...
		public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
            ...
            if (damageClass == ModContent.GetInstance<DamageClasses.UnholyVoid>()) {
				return new StatInheritanceData(
				damageInheritance: 1f,
				critChanceInheritance: 1f,
				attackSpeedInheritance: 1f,
	...
	public class UnholyVoidMeleeNoSpeed : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class UnholyVoidRanged : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class UnholyVoidMagic : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class UnholyVoidSummon : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
	...
	public class UnholyVoidSummonWhip : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)

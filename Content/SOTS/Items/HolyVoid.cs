...
{
	public class HolyVoid : DamageClass
	{
        ...
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
			...
			ModLoader.TryGetMod("SOTS", out Mod SOTS);
            if (damageClass == DamageClass.Generic || damageClass == ModContent.GetInstance<DamageClasses.Holy>() || damageClass == SOTS.Find<DamageClass>("VoidGeneric")) {
    ...
    public class HolyVoidMelee : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
		...
		public override StatInheritanceData GetModifierInheritance(DamageClass damageClass) {
            ...
            if (damageClass == ModContent.GetInstance<DamageClasses.HolyVoid>()) {
				return new StatInheritanceData(
				damageInheritance: 1f,
				critChanceInheritance: 1f,
				attackSpeedInheritance: 1f,
	...
	public class HolyVoidMeleeNoSpeed : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class HolyVoidRanged : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class HolyVoidMagic : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
    ...
    public class HolyVoidSummon : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
	...
	public class HolyVoidSummonWhip : DamageClass
	{
		public override void SetStaticDefaults() {
		}
        public override bool IsLoadingEnabled(Mod mod)
